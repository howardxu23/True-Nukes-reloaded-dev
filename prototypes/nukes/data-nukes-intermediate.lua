...
data:extend({
    ...
    type = "item",
    name = "californium",
    icon = nuke_graphics("californium.png"),
    ...
    pictures =
    {
        ...
        {
            size = 64,
            filename = nuke_graphics("californium.png"),
            scale = 0.25,
            mipmap_count = 4
        },
        {
    ...
    icon = nuke_graphics("californium-processing.png"),
    icon_size = 64, icon_mipmaps = 4,
    subgroup = "intermediate-product",
    ...
    icons = {
        {icon = nuke_graphics("californium-processing.png"), icon_size = 64, icon_mipmaps = 4},
...
data:extend{
{
    ...
    icons = {
    {icon = "__base__/graphics/icons/kovarex-enrichment-process.png", icon_size = 64, icon_mipmaps = 4},--combination icons
    {icon = nuke_graphics("plus-red.png"), icon_size = 32, scale = 0.333, shift = {10, -10}}
    },
    subgroup = "intermediate-product",
...
},
{
    type = "item",
    name = "FOGBANK",
    icon = nuke_graphics("FOGBANK.png"),
    icon_size = 64, icon_mipmaps = 4,
    subgroup = "intermediate-product",
    order = "r[fogbank]",
    stack_size = 50
...
data:extend{
{
    ...
    icon = nuke_graphics("neutron-reflector.png"),
    icon_size = 64, icon_mipmaps = 4,
    subgroup = "intermediate-product",
...
data:extend({
    ...
    icon = nuke_graphics("tritium-breeder-fuel-cell.png"),
    icon_size = 64, icon_mipmaps = 4,
    pictures =
    {
        layers =
        ...
        {
            size = 64,
            filename = nuke_graphics("tritium-breeder-fuel-cell.png"),
            scale = 0.25,
            mipmap_count = 4
        },
        {
            ...
            flags = {"light"},
            size = 64,
            filename = nuke_graphics("tritium-breeder-fuel-cell-light.png"),
            scale = 0.25,
            mipmap_count = 4
        }
        }
    ...
    icons = {
        {icon = nuke_graphics("tritium-breeder-fuel-cell.png"), icon_size = 64, icon_mipmaps = 4},
        {icon = nuke_graphics("plus-red.png"), icon_size = 32, scale = 0.333, shift = {10, -10}}
    },
    pictures =
    {
        ...
        {
            filename = nuke_graphics("plus-red.png"),
            size = 32,
            scale = 0.166,
            shift = {0.1875, -0.1875}
        },
    ...
    icon = nuke_graphics("used-up-tritium-breeder-fuel-cell.png"),
    icon_size = 64, icon_mipmaps = 4,
    subgroup = "intermediate-product",
    ...
    icons = {
        {icon = nuke_graphics("used-up-tritium-breeder-fuel-cell.png"), icon_size = 64, icon_mipmaps = 4},
        {icon = nuke_graphics("plus-red.png"), icon_size = 32, scale = 0.333, shift = {10, -10}}
    },
    subgroup = "intermediate-product",
    ...
    icon = nuke_graphics("tritium-canister.png"),
    icon_size = 64, icon_mipmaps = 1,
    pictures =
    {
        layers =
        ...
        {
            size = 64,
            filename = nuke_graphics("tritium-canister.png"),
            scale = 0.25,
            mipmap_count = 1
        },
        {
            ...
            flags = {"light"},
            size = 64,
            filename = nuke_graphics("tritium-canister-light.png"),
            scale = 0.25,
            mipmap_count = 1
        }
        }
